...
export default class ShoeShop extends Component {
    ...
    setStateModal = (shoe) => {
        ...
        document.getElementById('tbtInfor').style.display = 'flex';

        console.log('button: ', shoe.id);
        const { id, alias, name, price, description, shortDescription, quantity, image } = shoe;
